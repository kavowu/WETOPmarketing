...
import imgFilter from './src/assets/看不見的效果.png';
import imgMaintenance from './src/assets/持續維護壓力.jpg';
import imgSofa from './src/assets/表面汙染無效.png';
import imgVirus from './src/assets/病毒不只在空氣中.png';
...
export const PainPoints: React.FC = () => {
  ...
  const painPoints: PainPointItem[] = [
    ...
    },
    {
      ...
      quote: '如果威脅落落在物體表面，空氣清淨機再強，也吹不走孩子指尖即將碰到的危險。',
    },
    {
